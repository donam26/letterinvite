...
function ExamPrepOnlinePage() {
  ...
  const handleSubmit = async (e) => { 
    ...
    const result = await submitToGoogleSheet({
      formType: 'Online - Luyện thi ĐGNL/SAT/IELTS',
      ...form
    })
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg mb-6">
          ...
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl p-5 border border-amber-200 mb-6">
            <h4 className="font-bold text-amber-800 mb-3 flex items-center gap-2">
              ...
              Độc quyền cho một loại hình luyện thi duy nhất trên nền tảng:
            </h4>
          ...
          <div className="bg-slate-50 rounded-xl p-5 border border-slate-200 mb-6">
            ...
            <ul className="space-y-2 text-sm text-slate-700">
              <li className="flex items-start gap-2">
                ...
                <span>Biểu mẫu, đường link chuyển hoá</span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-2 h-2 bg-[#1E63F9] rounded-full mt-2 flex-shrink-0"></div>
                <span>Kịch bản chăm sóc khách hàng</span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-2 h-2 bg-[#1E63F9] rounded-full mt-2 flex-shrink-0"></div>
                <span>Tài trợ toàn bộ đề thi để học sinh tham gia kiểm tra đánh giá năng lực để nhận được phân tích đánh giá từ AI</span>
              </li>
            </ul>
          </div>
...
export default ExamPrepOnlinePage

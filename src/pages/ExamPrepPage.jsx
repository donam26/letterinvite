...
import {
  ...
  Users, CheckCircle, Sparkles, Bot, MapPin, ChevronRight, Building2, BookOpen
} from 'lucide-react'
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg">
            ...
            <button onClick={() => navigate('/exam-prep/offline')}
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg">
            ...
            <div className="space-y-2 mb-4">
              {['Chatbot AI tuyển sinh 24/7', 'Độc quyền theo loại hình luyện thi', 'Tiếp cận 100,000+ học sinh/năm'].map((item, i) => (
                <div key={i} className="flex items-center gap-2">
            ...
            <button onClick={() => navigate('/exam-prep/online')}

...
import {
  ...
  CheckCircle, Sparkles, Bot, Gift, HandMetal, Building2
} from 'lucide-react'

function InternationalOnlinePage() {
    ...
    <section className="min-h-screen bg-gradient-to-br from-[#1E63F9] via-[#1557E8] to-[#0847D4]">
      <header className="bg-white/10 backdrop-blur-sm sticky top-0 z-50 border-b border-white/10">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button onClick={() => navigate('/international/about')} className="flex items-center gap-2 text-white/80 font-medium hover:text-white transition-colors">
              <Info className="w-4 h-4" /> Về chúng tôi
            </button>
            <button onClick={() => navigate('/international/profile')} className="flex items-center gap-2 text-white/80 font-medium hover:text-white transition-colors">
              <FileText className="w-4 h-4" /> Hồ sơ năng lực
            </button>
            <button onClick={() => navigate('/international')} className="flex items-center gap-2 text-[#FFD447] font-medium hover:underline">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg mb-6">
          <p className="text-slate-900 font-bold text-lg mb-2">Kính gửi: Quý Đơn vị tuyển sinh – đào tạo quốc tế</p>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg mb-6">
          ...
          <div className="bg-[#1E63F9]/5 rounded-xl p-5 border border-[#1E63F9]/20 mb-6">
            <p className="text-slate-700 leading-relaxed">
              InterEdu đang vận hành nền tảng hướng nghiệp vì cộng đồng <span className="text-[#1E63F9] font-bold text-lg">hoàn toàn miễn phí</span> dành cho học sinh THPT. <span className="text-[#1E63F9] font-bold">Tất cả được tích hợp AI</span> để gợi ý những đề xuất thích hợp nhất cho học sinh.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl p-5 border border-amber-200 mb-6">
            <h4 className="font-bold text-amber-800 mb-3 flex items-center gap-2">
              ...
              Độc quyền cho một Quốc gia tư vấn duy nhất trên nền tảng:
            </h4>
            <ul className="space-y-3 text-sm text-slate-700">
              <li className="flex items-start gap-2">
                <div className="w-2 h-2 bg-amber-500 rounded-full mt-2 flex-shrink-0"></div>
                <span>Logo của Đơn vị được gắn trên trang web khu vực bảo trợ</span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-2 h-2 bg-amber-500 rounded-full mt-2 flex-shrink-0"></div>
                <span>Được tạo tài khoản / gắn biểu mẫu khai thác thông tin. <strong>Thông tin học sinh sẽ được chuyển hoá về cho Quý Đơn vị</strong></span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-2 h-2 bg-amber-500 rounded-full mt-2 flex-shrink-0"></div>
                <span>Được tạo tài khoản <strong>Chatbot AI</strong> kèm theo kịch bản chuyển hoá chăm sóc</span>
              </li>
            </ul>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div className="bg-amber-50 rounded-xl p-5 border border-amber-200">
              ...
              <p className="text-sm text-slate-600">Đối với các đơn vị tuyển sinh quốc tế</p>
              <div className="mt-3 pt-3 border-t border-amber-200">
                <p className="text-sm text-slate-500">2.000.000 VNĐ/tháng</p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3 p-3 bg-white rounded-lg border border-slate-200">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">500.000 VNĐ/tháng cho cam kết <strong>60 dữ liệu/năm</strong></p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-3 bg-white rounded-lg border border-slate-200">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">1.000.000 VNĐ/tháng - Cam kết chăm sóc tối đa <strong>3,000 học sinh</strong></p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#1E63F9]/5 rounded-xl p-5 border border-[#1E63F9]/20 mb-6">
            ...
            <ul className="space-y-2 text-sm text-slate-700">
              ...
              <li className="flex items-start gap-2"><span className="font-bold text-[#1E63F9]">2.</span><span>Quý Đơn vị chuyển khoản <strong>70% chi phí tài trợ</strong></span></li>
              ...
              <li className="flex items-start gap-2"><span className="font-bold text-[#1E63F9]">4.</span><span>Sau nghiệm thu, tài trợ <strong>30% còn lại</strong> và bắt đầu sử dụng</span></li>
              <li className="flex items-start gap-2"><span className="font-bold text-[#1E63F9]">5.</span><span>Chi phí thường niên thanh toán đầu mỗi Quý</span></li>
            </ul>
          </div>
          ...
          <div className="bg-gradient-to-r from-[#FFD447] to-[#FFC107] rounded-xl p-5 mb-6">
            <p className="text-slate-900 font-semibold text-center">
              🚀 Chúng tôi bắt đầu triển khai từ ngày <strong>10/01/2026</strong>
            </p>
          </div>

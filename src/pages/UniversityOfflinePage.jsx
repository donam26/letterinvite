...
function UniversityOfflinePage() {
  ...
  const handleSubmit = async (e) => { 
    ...
    const result = await submitToGoogleSheet({
      formType: 'Offline - Đại học/Cao đẳng',
      ...form
    })
    ...
    if (result.success) {
      alert('Cảm ơn Quý Trường đã đăng ký Gói đồng hành Offline!')
...
export default UniversityOfflinePage

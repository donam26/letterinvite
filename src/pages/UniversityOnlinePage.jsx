...
function UniversityOnlinePage() {
  ...
  const handleSubmit = async (e) => { 
    ...
    const result = await submitToGoogleSheet({
      formType: 'Online - Đại học/Cao đẳng',
      ...form
    })
      ...
      <header className="bg-white/10 backdrop-blur-sm sticky top-0 z-50 border-b border-white/10">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={() => navigate('/university')} className="flex items-center gap-2 text-[#FFD447] font-medium hover:underline">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg mb-6">
          ...
          <div className="space-y-3 mb-6">
            {[
              ...
              'Được tích hợp bộ dữ liệu ngành, chương trình đào tạo, điểm chuẩn, học phí…',
              'Được InterEdu cam kết kết nối với các học viên phù hợp với tiêu chí xét tuyển.',
            ].map((item, i) => (
          ...
          <div className="bg-emerald-50 rounded-xl p-5 border border-emerald-200 mb-6">
            ...
            <p className="text-emerald-700">
              Kết nối với các học viên phù hợp với tiêu chí xét tuyển của các Trường ĐH – CĐ.
            </p>
          </div>
...
export default UniversityOnlinePage
